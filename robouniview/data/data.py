...
class BaseCalvinDataset(Dataset):
    ...
    def __init__(
        ...
        with open('/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mlm/huangyiyang02/project/RoboFlamingo/enrich_lang_annotations.json', 'r') as f:
...
class DiskCalvinDataset(BaseCalvinDataset):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # ) /mnt/dolphinfs/hdd_pool/docker/user/hadoop-mlm/yanfeng/data/robotics/calvin/training/dict.json

        # yiyang_modify
        self.json_file_path = Path("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mlm/yanfeng/data/robotics/calvin/training/dict.json")
...
class CalvinSim(Dataset):
    def __init__(self,  
        ...
        # dataset_path = "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mlm/yanfeng/data/robotics/task_D_D"
        # calvin_conf_path = "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mlm/yanfeng/project/robotic/calvin/calvin_models/conf"
